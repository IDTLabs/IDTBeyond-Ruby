...
> We have three ways of generating a clientTransactionId. Your `client_transaction_id` is automatically generated by the gem, you can manually set one, or the server can generate one once it receives the request.
